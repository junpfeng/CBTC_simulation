...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mainGraph.setAutoFillBackground(True)
        self.mainGraph.setObjectName("mainGraph")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(70, 10, 67, 17))
        self.label.setObjectName("label")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(750, 30, 120, 411))
        self.widget.setObjectName("widget")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.widget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 179, 101, 211))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 9, 101, 111))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.textEdit_disp = QtWidgets.QTextEdit(self.verticalLayoutWidget_2)
        self.textEdit_disp.setObjectName("textEdit_disp")
        self.verticalLayout_3.addWidget(self.textEdit_disp)
